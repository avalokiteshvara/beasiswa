...
<body>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="<?php echo site_url('guest/ganti-password') ?>">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo site_url('guest/index') ?>">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo site_url('guest/kategori-beasiswa') ?>">
                    <i class="bi bi-grid"></i>
                    <span>Beasiswa</span>
                </a>
            </li>
