                ...
                <tr>
                  ...
                  <td>
                    <?php if($p['status'] === 'pending'){ ?>
                      <a class="diterima" href="<?php echo site_url('guest/set-status-pendaftaran/diterima/' . $p['id'] . '/' . base64url_encode($this->uri->segment(3)))?>" onclick="return confirm('Apakah anda yakin ingin menerima peserta ini?')">Terima</a>
                      |  <a class="ditolak" href="<?php echo site_url('guest/set-status-pendaftaran/ditolak/' . $p['id'] . '/' . base64url_encode($this->uri->segment(3)))?>" onclick="return confirm('Apakah anda yakin ingin menolak peserta ini?')">Tolak</a>
                    <?php }elseif ($p['status'] === 'diterima') { ?>
                      <span class="label label-success">Diterima</span> - <a href="<?php echo site_url('guest/cetak_bukti_pendaftaran/' . base64url_encode($p['id']))?>">[ Download Bukti ]</a>
                    <?php }else{ ?>
