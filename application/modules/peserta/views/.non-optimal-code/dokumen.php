                ...
                <tbody>
                    ...
                    ?>
                        <?php if ($jd['user_file_dokumen'] === 'belum' && $jd['verifikasi'] === '-') { ?>
                            <tr class="table-default" id="tr_<?php echo $i ?>">
                            <?php } elseif ($jd['user_file_dokumen'] !== 'belum' && $jd['verifikasi'] === 'belum') { ?>
                            <tr class="table-warning" id="tr_<?php echo $i ?>">
                            <?php } else { ?>
                            <tr class="table-success" id="tr_<?php echo $i ?>">
                            <?php } ?>
                            ...
                            <td>
                                <?php if ($jd['verifikasi'] === 'ditolak') { ?>
                                    <span class="badge bg-danger toggle-collapse"><i class="bi bi-x-circle" aria-hidden="true"></i>&nbsp;DITOLAK <i class="bi bi-chevron-down"></i></span>
                                <?php } elseif ($jd['verifikasi'] === 'diterima') { ?>
                                    <span class="badge bg-success"><i class="bi bi-check-lg" aria-hidden="true"></i>&nbsp;DITERIMA</span>
                                    <script>
                                        const collapseElement<?php echo $i ?> = document.querySelector('#r<?php echo $i; ?>');
                                        collapseElement<?php echo $i ?>.classList.remove('collapse');
                                    </script>
