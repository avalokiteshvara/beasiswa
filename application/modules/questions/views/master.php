...
<head>
    ...
    <title>ADMIN PERTANYAAN| Beasiswa</title>
...
<body>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="<?php echo site_url('questions/ganti-password') ?>">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo site_url('questions/index') ?>">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo site_url('questions/daftar') ?>">
                    <i class="bi bi-grid"></i>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            <p align="center">&copy;<strong><span><font size="2"> Biro Kesra Provinsi Jambi. 2023</span></strong></font></p>
        </div>
        <div class="credits">
