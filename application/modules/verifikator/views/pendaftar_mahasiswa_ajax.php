   ...
   <div class="panel-heading">
      ...
      <div class="btn-group float-end mb-2">
         ...
         <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="<?php echo site_url('verifikator/export_data/' . base64url_encode('pdf/' . $this->uri->segment(3) . '/semua')) ?>">Semua pendaftar (*.pdf)</a></li>
            <li><a class="dropdown-item" href="<?php echo site_url('verifikator/export_data/' . base64url_encode('pdf/' . $this->uri->segment(3) . '/terpilih')) ?>">Pendaftar diterima (*.pdf)</a></li>
            <li>
               <hr class="dropdown-divider">
            </li>
            <li><a class="dropdown-item" href="<?php echo site_url('verifikator/export_data/' . base64url_encode('excel/' . $this->uri->segment(3) . '/semua')) ?>">Semua pendaftar (*.xls)</a></li>
            <li><a class="dropdown-item" href="<?php echo site_url('verifikator/export_data/' . base64url_encode('excel/' . $this->uri->segment(3) . '/terpilih')) ?>">Pendaftar diterima (*.xls)</a></li>
         </ul>
      </div>
   </div>
...
<script>
   ...
   function load_dokumen(pendaftar_id) {
      ...
      $.get("<?php echo site_url('verifikator/load_dokumen') ?>", {
