...
<html lang="en">
   <head>
      ...
      <!-- <script src="<?php echo site_url('assets/manage/js/jquery.doubleScroll.js')?>"></script> -->
               ...
               <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="dropdown ">
                     ...
                     <ul class="dropdown-menu" role="menu">
                        ...
                        <li class=""><a href="#">Other Link</a></li>
                        <li class="divider"></li> -->
                        <li><a href="<?php echo site_url('verifikator/ganti-password')?>">Ganti Password</a></li>
                  ...
                  <nav class="navbar navbar-default" role="navigation">
                     ...
                     <div class="side-menu-container">
                        <ul class="nav navbar-nav main-menu">
                           <li class="active"><a href="<?php echo site_url('verifikator/index')?>"><span class="glyphicon glyphicon-dashboard"></span> Dashboard</a></li>
                           <li><a href="<?php echo site_url('verifikator/kategori-beasiswa')?>"><span class="glyphicon glyphicon-list-alt"></span> Beasiswa</a></li>
                           <!-- <li><a href="<?php echo site_url('verifikator/jenis-dokumen')?>"><span class="glyphicon glyphicon-file"></span> Jenis Dokumen</a></li> -->
                           <!-- <li><a href="<?php echo site_url('verifikator/data-user')?>"><span class="glyphicon glyphicon-user"></span> Data User</a></li> -->
