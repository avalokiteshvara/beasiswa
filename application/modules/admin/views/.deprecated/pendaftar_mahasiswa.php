                  ...
                  <?php
                     ...
                     if(!empty($p['dokumen'])){
                      ...
                      //  echo '<a class="btn btn-primary" role="button" data-toggle="collapse" href="#collapse' . $p['id'] .'" aria-expanded="false" aria-controls="collapse' . $p['id'] .'">Detail</a>';
                       ...
                       $status_rekap['sudah_upload'] = $count_doc;

                       if($count_doc > 0){

                         $dokumen_uploaded = array();

                         $sudah_upload_pending = 0;
                         $sudah_upload_terima = 0;
                         $sudah_upload_tolak = 0;
                         ...
                         foreach ($dokumen_list as $dok) {
                          ...
                          //1|-kartu-tanda-penduduk.jpg|pending;
                           ...
                           if($dokumen[2] === 'pending'){
                             ...
                             $sudah_upload_pending += 1;
                           }elseif($dokumen[2] === 'diterima'){
                             echo '<span class="label label-success">Diterima</span>';
                             $sudah_upload_terima += 1;
                           }else{
                             echo '<span class="label label-danger">Ditolak</span>';
                             $sudah_upload_tolak += 1;
                           }
                           echo '</td>';
                         ...
                         $status_rekap['sudah_upload_pending'] = $sudah_upload_pending;
                         $status_rekap['sudah_upload_terima'] = $sudah_upload_terima;
                         $status_rekap['sudah_upload_tolak'] = $sudah_upload_tolak;
                         ...
                         $status_rekap['belum_upload'] = $count_diff;
                       ...
                       $status_rekap['belum_upload'] = 0;
                       $status_rekap['sudah_upload'] = 0;
                       $status_rekap['sudah_upload_pending'] = 0;
                       $status_rekap['sudah_upload_terima'] = 0;
                       $status_rekap['sudah_upload_tolak'] = 0;
