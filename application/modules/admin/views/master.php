   ...
   <body>
                  ...
                  <nav class="navbar navbar-default" role="navigation">
                     ...
                     <div class="side-menu-container">
                        <ul class="nav navbar-nav main-menu">
                           ...
                           <li><a href="<?php echo site_url('admin/kategori-beasiswa')?>"><span class="glyphicon glyphicon-list-alt"></span> Beasiswa</a></li>
                           <li><a href="<?php echo site_url('admin/jenis-dokumen')?>"><span class="glyphicon glyphicon-file"></span> Jenis Dokumen</a></li>
                           <li><a href="<?php echo site_url('admin/web-content')?>"><span class="glyphicon glyphicon-book"></span> Web Konten</a></li>
                           <li><a href="<?php echo site_url('admin/faq-list')?>"><span class="glyphicon glyphicon-book"></span> FAQ List</a></li>
                           <li><a href="<?php echo site_url('admin/data-user')?>"><span class="glyphicon glyphicon-user"></span> Data User</a></li>
         ...
         <div class="col-md-10 content">
           ...
           <?php
             ...
             if($uri2 === 'pendaftar_ajax'){ ?>
               <div class="panel panel-primary" id="rekap">
      ...
      <script type="text/javascript">
         $(function () {
          ...
          (function worker() {
            $.ajax({
              url: '<?php echo site_url('rekap/index/' . base64url_encode($this->uri->segment(3)))?>',
