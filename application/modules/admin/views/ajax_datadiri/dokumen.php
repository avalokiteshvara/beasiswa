<div class="alert alert-danger" id="alert_dok_danger" style="display:none">
    <strong>Peringatan!</strong> <br /><div id="dok_msg_danger"></div>
 </div>
 <div class="alert alert-success" id="alert_dok_success" style="display:none">
    <strong>Info!</strong> <br /><div id="dok_msg_success"></div>
 </div>
   ...
   <tbody>
      ...
      <tr class="success" id="tr_<?php echo $jd['id'];?>">
         ...
         <td>
            ...
            <?php }else{ ?>
            <span class="label label-success"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;SUDAH</span> - <a href="<?php echo site_url('uploads/dokumen/' . $jd['user_file_dokumen'])?>?random=<?php echo date("YmdHis")?>" target="_blank" id="dok_link_<?php echo $jd['id']?>">Lihat</a>
           ...
           success: function(data)
           {
             ...
             if(data.status !== 'OK'){
                ...
                if(data.dok_link !== 'none'){
                  ...
                  $('#td_verifikasi_' + jenis_dokumen_id).html('<span class="label label-warning"><span class="glyphicon glyphicon-hourglass" aria-hidden="true"></span>&nbsp;MENUNGGU</span>');
